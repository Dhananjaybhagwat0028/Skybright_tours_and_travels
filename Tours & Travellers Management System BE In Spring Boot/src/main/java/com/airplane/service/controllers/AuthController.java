...
public class AuthController {
    ...
    public ResponseEntity<BasicResponseDTO<RegisterResponseDTO>> registerUser(@RequestBody SignUpRequestDTO registerRequestDTO) {
        ...
        if(!registerRequestDTO.getRole().equalsIgnoreCase("customer") && !registerRequestDTO.getMasterPassword().equals("skyBright") ){
        ...
        user.setFlightCompany(registerRequestDTO.getFlightCompany());
    ...
    public SignInResponseDTO loginHelper(String email, String password) {
        ...
        signInDTO.setFlightCompany(user.getFlightCompany());
